    ...
    public void onScrollFinish() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
            	...
            	ArtBookUtils.saveBitmap(ArtBookUtils.loadBitmapFromViewByCapture(getContext(),webView), "loading"+currentPage+".png");
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                if (url.equals("file:///android_asset/book.css")) {
                    ...
                    builder.append("" +
                            ...
                            "        }" +
                            "        img{\n" +
                            "            max-width: " + (dpWidth - 20) + "px;\n" +
                            "        }" +
                            "        article {" +
                            "            " +//margin: 4px 5px 4px 5px;
                            "        }" +
                            "        article{" +
                            "            -webkit-column-width:" + dpWidth + "px;" +
                            "            -webkit-column-gap: 10px;" +
                            "            height:" + (dpHeight - 20-40) + "px;" +
                            "            padding: 0px;" +
                            "            margin:0px;" +
                            "            margin-top:40px" +
                            "        }" +
